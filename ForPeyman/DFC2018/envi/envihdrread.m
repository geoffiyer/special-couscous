...
%% Geoff note:
% The below appears to be doing some fancy stuff with the real-world
% location of the picture. 1) I don't care, and 2) there were errors in the
% code. So this is commented out now.
